...
std::string
ExecuteJsonResponseOnlyApi(std::function<ResponseStructType()> call_function) {
...
std::string
JsonMappingApi::CreateFundTransaction(const std::string &request_message) {
  return ExecuteJsonApi<
    api::json::CreateFundTransactionRequest,
...
std::string
JsonMappingApi::CreateBatchFundTransaction(const std::string &request_message) {
  return ExecuteJsonApi<
    api::json::CreateBatchFundTransactionRequest,
...
std::string
JsonMappingApi::GetRawFundTxSignature(const std::string &request_message) {
  return ExecuteJsonApi<
    api::json::GetRawFundTxSignatureRequest,
...
std::string JsonMappingApi::AddSignatureToFundTransaction(
  const std::string &request_message) {
  return ExecuteJsonApi<
    api::json::AddSignatureToFundTransactionRequest,
...
std::string
JsonMappingApi::SignFundTransaction(const std::string &request_message) {
  return ExecuteJsonApi<
    api::json::SignFundTransactionRequest,
...
std::string
JsonMappingApi::VerifyFundTxSignature(const std::string &request_message) {
  return ExecuteJsonApi<
    api::json::VerifyFundTxSignatureRequest,
...
std::string
JsonMappingApi::CreateRefundTransaction(const std::string &request_message) {
  return ExecuteJsonApi<
    api::json::CreateRefundTransactionRequest,
...
std::string
JsonMappingApi::CreateDlcTransactions(const std::string &request_message) {
  return ExecuteJsonApi<
    api::json::CreateDlcTransactionsRequest,
...
std::string
JsonMappingApi::CreateCetAdaptorSignatures(const std::string &request_message) {
  return ExecuteJsonApi<
    api::json::CreateCetAdaptorSignaturesRequest,
...
std::string JsonMappingApi::SignCet(const std::string &request_message) {
  return ExecuteJsonApi<
    api::json::SignCetRequest, api::json::SignCetResponse,
    api::SignCetRequestStruct, api::SignCetResponseStruct>(
    request_message, DlcTransactionsApi::SignCet);
}

std::string
JsonMappingApi::VerifyCetAdaptorSignature(const std::string &request_message) {
  return ExecuteJsonApi<
    api::json::VerifyCetAdaptorSignatureRequest,
...
std::string
JsonMappingApi::VerifyCetAdaptorSignatures(const std::string &request_message) {
  return ExecuteJsonApi<
    api::json::VerifyCetAdaptorSignaturesRequest,
...
std::string
JsonMappingApi::GetRawRefundTxSignature(const std::string &request_message) {
  return ExecuteJsonApi<
    api::json::GetRawRefundTxSignatureRequest,
...
std::string
JsonMappingApi::AddSignaturesToRefundTx(const std::string &request_message) {
  return ExecuteJsonApi<
    api::json::AddSignaturesToRefundTxRequest,
...
std::string
JsonMappingApi::VerifyRefundTxSignature(const std::string &request_message) {
  return ExecuteJsonApi<
    api::json::VerifyRefundTxSignatureRequest,
